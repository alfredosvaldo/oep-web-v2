...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Mapa vivo, rankings y fichas de actores y territorio de los 30.119 expedientes del SEIA (1993–2026-T2): regiones, sectores, titulares y tiempos de aprobación.',
