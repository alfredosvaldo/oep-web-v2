...
REMOTE="https://github.com/alfredosvaldo/oep-web-v2.git"
TMP="$(mktemp -d)"
trap 'rm -rf "$TMP"' EXIT

# GHPAGES=1 activa basePath/assetPrefix /oep-web-v2 (ver next.config.mjs)
...
echo "OK — gh-pages actualizada. Sitio: https://alfredosvaldo.github.io/oep-web-v2/"
